# Generated by Django 5.0.6 on 2024-05-21 23:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stats', models.CharField(choices=[('3', 'Aprovado'), ('2', 'Cancelado'), ('1', 'Pendente')], max_length=30)),
                ('stars', models.CharField(choices=[('5', '5'), ('2', '2'), ('1', '1'), ('3', '3'), ('4', '4')], max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.CharField(choices=[('0', 'user'), ('3', 'admin'), ('2', 'author'), ('1', 'librarian')], max_length=30)),
